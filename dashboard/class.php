...
if(isset($_POST['create_btn'])){
	...
	$student_id = $_SESSION['st_logedin'][0]['id'];
...
$current_class_status = Student('current_class',$_SESSION['st_logedin'][0]['id']);
					...
					<div class="widget-inner">
						<form class="edit-profile m-b30" method="POST" action="">
							<div class="row"> 
								...
								<div class="col-12"> 
									<button type="submit" name="create_btn" class="btn">New Class Registration</button>
								</div>
							</div>
						</form>
					</div>
